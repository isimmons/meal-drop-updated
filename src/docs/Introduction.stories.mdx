...
<div class="link-list">
  <a
    class="link-item"
    href="https://github.com/yannbf/storybook-for-react-apps"
    target="_blank"
  >
  ...
  <a class="link-item" href="https://discord.gg/wrn8CUMkuH" target="_blank">
    ...
    <span>
      ...
      Chat with the course instructor and the <strong>
        newline community
      </strong> in the <pre>#storybook-for-react-apps</pre> channel
    </span>
  </a>
</div>
...
<div class="link-list">
  <a
    class="link-item link-item--title-only"
    href="https://twitter.com/yannbf"
    target="_blank"
  >
